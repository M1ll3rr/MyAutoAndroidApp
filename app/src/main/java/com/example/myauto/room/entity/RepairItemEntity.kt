...
@Entity(
    ...
    indices = [
        Index(value = ["carId"], name = "idx_repair_car_id"),
        Index(value = ["date"], name = "idx_repair_date"),
        Index(value = ["category"], name = "idx_repair_category"),
        Index(value = ["totalCost"], name = "idx_repair_total_cost")
    ]
)
